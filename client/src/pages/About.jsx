    ...
    <div className="custom-container">
      <div className="row">
        <div className="col-lg-6">
          <div className="banner-section"><img src="./images/blog/1.jpg" className="img-fluid   w-100" alt /></div>
        </div>
        <div className="col-lg-6">
          <h4 className="top-text">  <b>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium </b></h4>
          <p className="mb-2"> Sed ut perspiciatis unde omnis iste natus <b>error sit</b> voluptatem accusantium doloremque laudantium,</p>
          ...
          <p className="mb-2">  These <b>cases</b> are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents our</p>
          <p className="mb-2"> being able to do what we like best, every pleasure is to be <b>welcomed</b> and every pain avoided. But in certain circumstances and owing to the claims of duty or the obligations of business it will frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects pleasures to secure other greater pleasures, or else he endures pains to avoid <b>worse</b> pains.</p>
        </div>
      </div>
    </div>
  </section>
...
<section className="testimonial testimonial-inverse">
        ...
        <OwlCarousel className="owl-theme" style={{width:'100%',height:'100%'}} {...options}>
            ...
            <div className="testimonial-contain">
              <div className="media">
                <div className="testimonial-img">
                  <img src="./images/testimonial/1.jpg" className="img-fluid rounded-circle  " alt="testimonial" />
                </div>
          ...
          <div>
            <div className="testimonial-contain">
              <div className="media">
                <div className="testimonial-img">
                  <img src="./images/testimonial/2.jpg" className="img-fluid rounded-circle" alt="testimonial" />
                </div>
                <div className="media-body">
                  <h5>mark jecno</h5>
                  <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
          ...
          <div>
            <div className="testimonial-contain">
              <div className="media">
                <div className="testimonial-img">
                  <img src="./images/testimonial/3.jpg" className="img-fluid rounded-circle" alt="testimonial" />
                </div>
                <div className="media-body">
                  <h5>mark jecno</h5>
                  <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
      ...
      <div className="row">
        <div className="col-sm-12">
          ...
          <div className="team-6">
            <div>
              <div>
                <img src="./images/about/team/1.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>Hileri Keol</h4>
            ...
            <div>
              <div>
                <img src="./images/about/team/2.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>Hileri Keol</h4>
              <h6>CEo &amp; Founder At Company</h6>
            </div>
            <div>
              <div>
                <img src="./images/about/team/3.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>Hileri Keol</h4>
              <h6>CEo &amp; Founder At Company</h6>
            </div>
            <div>
              <div>
                <img src="./images/about/team/4.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>Hileri Keol</h4>
              <h6>CEo &amp; Founder At Company</h6>
            </div>
            <div>
              <div>
                <img src="./images/about/team/5.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>Hileri Keol</h4>
              <h6>CEo &amp; Founder At Company</h6>
            </div>
  ...
  {/*Team ends*/}
  {/*services start*/}
  <section className="services section-big-mb-space">
    <div className="container">
      <div className="row service-block">
        ...
        <div className="col-lg-3 col-md-6  col-sm-12">
          <div className="media">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 417.12 417.12" style={{enableBackground: 'new 0 0 417.12 417.12'}} xmlSpace="preserve">
              <g>
                <g>
        ...
        <div className="col-lg-3 col-md-6  col-sm-12 ">
          <div className="media">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 448 448" style={{enableBackground: 'new 0 0 448 448'}} xmlSpace="preserve">
              <g>
                <g>
                  <g>
