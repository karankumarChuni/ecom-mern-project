            ...
            >
              <div className="col-lg-6 px-4 pt-3">
                <div className="row">
                  ...
                  <div
                    className="col-lg-6 col-md-7 col-8 d-flex justify-content-end"
                    style={{ gap: "22px" }}
                  >
              ...
              <div className="col-lg-6 px-4 pt-3">
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-7 col-8 d-flex justify-content-end">
                    <p className="customcolor">
                      {agentsuperadmin === true ? "Super Admin" : " Agent"}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-7 col-8 d-flex justify-content-end">
                    <p className="customcolor ps-4">
                      {last_updated_by ? last_updated_by : "NOT MODIFIED"}
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 px-4 pt-3">
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-7 col-8 d-flex justify-content-end">
                    <p className="customcolor ps-4">
                      {last_updated_at ? last_updated_at : "NOT MODIFIED"}
                    </p>
                  </div>
                </div>
              </div>
                      ...
                      <div className="col-12">
                        <div className="border round py-3 d-flex justify-content-center">
                          ...
                          >
                            ...
                            <img
                              src={
                                rifimg2 === "" || rifimg2 === null ? img5 : img4
                              }
                              alt="rif"
                              style={{
                                position: "absolute",
                            ...
                            <img
                              src={
                                rmfimg2 === "" || rmfimg2 === null ? img5 : img4
                              }
                              alt="rmf"
                              style={{
                                position: "absolute",
                            ...
                            <img
                              src={
                                rrfimg2 === "" || rrfimg2 === null ? img5 : img4
                              }
                              alt="rrf"
                              style={{
                                position: "absolute",
                            ...
                            <img
                              src={
                                rlfimg2 === "" || rlfimg2 === null ? img5 : img4
                              }
                              alt="rlf"
                              style={{
                                position: "absolute",
                          ...
                          >
                            ...
                            <img
                              src={
                                llfimg2 === "" || llfimg2 === null ? img5 : img4
                              }
                              alt="llf"
                              style={{
                                position: "absolute",
                            ...
                            <img
                              src={
                                lrfimg2 === "" || lrfimg2 === null ? img5 : img4
                              }
                              alt="lrf"
                              style={{
                                position: "absolute",
                            ...
                            <img
                              src={
                                lmfimg2 === "" || lmfimg2 === null ? img5 : img4
                              }
                              alt="lmf"
                              style={{
                                position: "absolute",
                            ...
                            <img
                              src={
                                lifimg2 === "" || lifimg2 === null ? img5 : img4
                              }
                              alt="lif"
                              style={{
                                position: "absolute",
                            ...
                            <img
                              src={
                                ltfimg2 === "" || ltfimg2 === null ? img5 : img4
                              }
                              alt="ltf"
                              style={{
                                position: "absolute",
