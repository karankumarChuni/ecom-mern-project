                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 px-4" style={{ paddingTop: "28px" }}>
                    <div className="row">
                      ...
                      <div
                        className="col-lg-6 col-md-7 col-8 d-flex justify-content-end d-flex"
                        style={{ gap: "22px" }}
                      >
            ...
            <div className="modal-body">
              ...
              >
                <div className="col-12 px-2 pt-3">
                  <img
                    src={
                      customerphotograph === null ? img3 : customerphotograph
                    }
                    style={{ width: "100%", height: "100%" }}
                    alt="photograph"
                  />
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          borderRadius: "3px",
                          paddingBottom:
                            clrfimg2 != "" && crrfimg2 != null ? "" : "3rem",
                          width: "20%",
                        }}
                      >
                        {" "}
                        {clrfimg2 != "" && crrfimg2 != null ? (
                          <img
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          borderRadius: "3px",
                          paddingBottom:
                            crlfimg2 != "" && crrfimg2 != null ? "" : "3rem",
                          width: "20%",
                        }}
                      >
                        {" "}
                        {crlfimg2 != "" && crrfimg2 != null ? (
                          <img
