      ...
      <div className="dashboardcontent px-2">
        ...
        {srtloader === true ? (
          ...
          <form onSubmit={submitform}>
            <div className="container-fuild pb-4 pt-4 px-2 bg-white">
              <div
              ...
              >
                  ...
                  <div className="col-xl-6 px-lg-4 px-md-2 pt-3">
                    <div className="row">
                      ...
                      <div
                        className={
                          documentsuperres === "SUCCESS"
                            ? `col-4 d-flex justify-content-between justify-content-between`
                            : `col-9 d-flex justify-content-end`
                        }
                        style={{ gap: "22px" }}
                      >
                ...
                <div className="col-12">
                  <div className="row">
                    ...
                    <div
                      className="col-xl-6 col-lg-12 px-xl-4 px-2"
            ...
            <div className="modal-body">
              ...
              >
                <div className="col-12 px-2 pt-3">
                  <img
                    src={
                      documentimageback2 === null ? img3 : documentimageback2
                    }
                    style={{ width: "100%", height: "100%" }}
                    alt="photograph"
                  />
