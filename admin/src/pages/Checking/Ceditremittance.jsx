...
const Ceditremittance = () => {
  ...
  const [kycaddress, setkycaddress] = useState(
    "rz-58 a3-block dharampura najfgarh"
  );
      ...
      try {
        ...
        if (check) {
          ...
          if (response.data.responseCode === "E00029") {
            ...
            setdocumentsupermsg(
              "Error Code: CR0001. Please contact your Administrator"
            );
          } else {
            setdocumentsuperres(response.data.data.kycStatus);
          ...
          if (documenttype === "VOTERID") {
            ...
            if (response.data.download.kycStatus === "SUCCESS") {
              ...
              setkycphoto(response.data.search.kycResult.photo);
              setkycfullname(
                response.data.download.kycResult.personalIdentifiableData
                  .personalDetails.fullName
              );
              setkycfathername(
                response.data.download.kycResult.personalIdentifiableData
                  .personalDetails.fatherFullname
              );
              setkycdob(
                response.data.download.kycResult.personalIdentifiableData
                  .personalDetails.dob
              ...
              setkycaddress(
                response.data.download.kycResult.personalIdentifiableData
                  .personalDetails.corresLine1
              );
              setkyccountry(
                response.data.download.kycResult.personalIdentifiableData
                  .personalDetails.corresCountry
              );
              setkycstate(
                response.data.download.kycResult.personalIdentifiableData
                  .personalDetails.corresState
              );
              setkyccity(
                response.data.download.kycResult.personalIdentifiableData
                  .personalDetails.corresCity
              );
              setkycpincode(
                response.data.download.kycResult.personalIdentifiableData
                  .personalDetails.corresPin
              );
              setkycemail(
                response.data.download.kycResult.personalIdentifiableData
              ...
              setkycphone(
                response.data.download.kycResult.personalIdentifiableData
                  .personalDetails.mobNum
              );
              setkycphonecode(
                response.data.download.kycResult.personalIdentifiableData
                  .personalDetails.mobCode
              );
  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      <div className="dashboardcontent px-2">
        ...
        {srtloader === true ? (
          <div
            className="container-fuild bg-white"
              ...
              >
                  ...
                  <div className="col-12 px-lg-4 px-md-2 pt-3">
                    <div className="row d-flex justify-content-center">
                      ...
                      <div
                        className={
                          documentsuperres === "SUCCESS"
                            ? `col d-flex justify-content-between justify-content-between`
                            : `col-9 d-flex justify-content-end`
                        }
                        style={{ gap: "22px" }}
                      >
                ...
                {documentsuperres === "SUCCESS" ? (
                  <div className="col-12 px-lg-4 px-md-2 pt-3">
                    <div className="row d-flex justify-content-center">
                      ...
                      {documentsuperres === "SUCCESS" ? (
                        <div
                          className="col d-flex customcolor"
                          style={{ flex: "wrap" }}
                        >
                          {kycemail}
                        </div>
                  ...
                  <div className="col-xl-6 px-4 pt-3">
                    <div className="row">
                      ...
                      <div
                        className={
                          documentsuperres === "SUCCESS"
                            ? `col-xl-8 col-lg-4 col-8 d-flex justify-content-between`
                            : `col-9 d-flex justify-content-end`
                        }
                        style={{ gap: "22px" }}
                      >
                      ...
                      {documentsuperres === "SUCCESS" ? (
                        <div className="col-xl-8 col-lg-4 col-8 offset-xl-3 offset-lg-0 offset-3 customcolor">
                          {kycemail}
                        </div>
                      ) : (
                        ""
                    ...
                    <div className="row d-flex justify-content-center">
                      ...
                      <div
                        className={
                          documentsuperres === "SUCCESS"
                            ? `col d-flex justify-content-between`
                            : `col-9 d-flex justify-content-end justify-content-end`
                        }
                        style={{ gap: "12px" }}
                      >
                  ...
                  <div className="col-xl-6 px-4 pt-3">
                    <div className="row">
                      ...
                      <div
                        className={
                          documentsuperres === "SUCCESS"
                            ? `col-8 d-flex justify-content-between`
                            : `col-9 d-flex justify-content-end`
                        }
                        style={{ gap: "22px" }}
                      >
                      ...
                      {documentsuperres === "SUCCESS" ? (
                        <div className="col-8 offset-3 customcolor">
                          {kycphone}
                        </div>
                      ) : (
                        ""
                ...
                {documentsuperres === "SUCCESS" ? (
                  ...
                  <div className="col-xl-6 px-4 pt-3">
                    <div className="row">
                      ...
                      {documentsuperres === "SUCCESS" ? (
                        <div className="col-4 customcolor">
                          {getName(kyccountry)}
                        </div>
                      ) : (
                        ""
                ...
                <div className="col-12">
                  <div className="row">
                        ...
                        <div
                          className={
                            documentsuperres === "SUCCESS"
                              ...
                              : `col-8 d-flex justify-content-between justify-content-end`
                          }
                          style={{ gap: "22px" }}
                        >
                    ...
                    <div
                      className="offset-col-6 col-md-6 px-4"
                      style={{ paddingTop: "28px" }}
                    >
                      <div className="row">
                        <div className="col-lg-4">Document Front Image</div>
                        <div className="col-lg-8">
                          <img
                            src={aadhaarImage}
                            alt="Modified Aadhaar Card"
                    ...
                    >
                      <div className="row">
                        <div className="col-lg-4">Document Back Image</div>
                        <div className="col-lg-8">
                          <img
                    ...
                    {idno === 5 ? (
                      <div className="col-12 px-4 d-flex">
                        {" "}
                        <div
                          className="col-12 col-offset-2 alert alert-danger mt-3 ms-1"
                          role="alert"
                        >
                          <h5 style={{ padding: "0px", margin: "0px" }}>
                  ...
                  <div className="row">
                    ...
                    >
                      <label htmlFor="tf2" className="form-label ">
                        Right Thumb <span style={{ color: "red" }}>*</span>
                      </label>
                  ...
                  <div className="row">
                    ...
                    >
                      <label htmlFor="ltf2" className="form-label ">
                        Left Thumb <span style={{ color: "red" }}>*</span>
                      </label>
                  ...
                  <div className="row">
                    ...
                    >
                      <label htmlFor="lrf2" className="form-label ">
                        Left Ring Finger <span style={{ color: "red" }}>*</span>
                      </label>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              >
                <div className="col-12 px-2 pt-3">
                  <img
                    src={aadhaarImage === null ? img3 : aadhaarImage}
                    style={{ width: "100%", height: "100%" }}
                    alt="photograph"
                  />
                </div>
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      >
                        ...
                        {cthumbimg2 != "" && cthumbimg2 != null ? (
                          <img
                            src={`data:image/png;base64,${cthumbimg2}`}
                            width="70px"
                            height="60px"
                            alt="asd"
                          />
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      >
                        ...
                        {cltfimg2 != "" && cltfimg2 != null ? (
                          <img
                            src={`data:image/png;base64,${cltfimg2}`}
                            width="70px"
                            height="60px"
                            alt="asd"
                          />
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      >
                        ...
                        {crifimg2 != "" && crifimg2 != null ? (
                          <img
                            src={`data:image/png;base64,${crifimg2}`}
                            width="70px"
                            height="60px"
                            alt="asd"
                          />
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      >
                        ...
                        {clifimg2 != "" && clifimg2 != null ? (
                          <img
                            src={`data:image/png;base64,${clifimg2}`}
                            width="70px"
                            height="60px"
                            alt="asd"
                          />
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      >
                        ...
                        {crmfimg2 != "" && crmfimg2 != null ? (
                          <img
                            src={`data:image/png;base64,${crmfimg2}`}
                            width="70px"
                            height="60px"
                            alt="asd"
                          />
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      >
                        ...
                        {clmfimg2 != "" && clmfimg2 != null ? (
                          <img
                            src={`data:image/png;base64,${clmfimg2}`}
                            width="70px"
                            height="60px"
                            alt="asd"
                          />
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      >
                        ...
                        {crrfimg2 != "" && crrfimg2 != null ? (
                          <img
                            src={`data:image/png;base64,${crrfimg2}`}
                            width="70px"
                            height="60px"
                            alt="asd"
                          />
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      >
                        ...
                        {clrfimg2 != "" && clrfimg2 != null ? (
                          <img
                            src={`data:image/png;base64,${clrfimg2}`}
                            width="70px"
                            height="60px"
                            alt="asd"
                          />
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      >
                        ...
                        {crlfimg2 != "" && crlfimg2 != null ? (
                          <img
                            src={`data:image/png;base64,${crlfimg2}`}
                            width="70px"
                            height="60px"
                            alt="asd"
                          />
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      >
                        ...
                        {cllfimg2 != "" && cllfimg2 != null ? (
                          <img
                            src={`data:image/png;base64,${cllfimg2}`}
                            width="70px"
                            height="60px"
                            alt="asd"
                          />
