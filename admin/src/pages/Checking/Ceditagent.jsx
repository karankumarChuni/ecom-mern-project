                      ...
                      <div className="col-9">
                        <div className="row">
                          <div
                            className={
                              documentsuperres === "SUCCESS"
                                ? `col-xl-12 col-lg-5 col-12 d-flex justify-content-between`
                                : `col-12 d-flex justify-content-end`
                            }
                            style={{ gap: "22px" }}
                          >
                          ...
                          {documentsuperres === "SUCCESS" ? (
                            <div className="col-xl-12 col-lg-4 col-12 customcolor">
                              {kycemail}
                            </div>
                          ) : (
                            ""
                  ...
                  <div className="col-xl-6 px-lg-4 px-2 pt-3">
                    <div className="row">
                      ...
                      <div
                        className={
                          documentsuperres === "SUCCESS"
                            ? `col-xl-5 col-lg-4 col-5 d-flex justify-content-between`
                            : `col-9 d-flex justify-content-end`
                        }
                        style={{ gap: "22px" }}
                      >
                      ...
                      {documentsuperres === "SUCCESS" ? (
                        <div className="col-3 customcolor">{kycfullname}</div>
                      ) : (
                        ""
                      )}
                    </div>
                ...
                {documentsuperres === "SUCCESS" ? (
                  ...
                  <div className="col-xl-6 px-lg-4 px-2 pt-3">
                    <div className="row">
                      ...
                      {documentsuperres === "SUCCESS" ? (
                        <div className="col-3 customcolor">{kycage}</div>
                      ) : (
                        ""
                      )}
                    </div>
                  ...
                  <div className="col-xl-6 px-lg-4 px-2 pt-3">
                    <div className="row">
                      ...
                      <div
                        className={
                          documentsuperres === "SUCCESS"
                            ? `col-xl-5 col-lg-4 col-4 d-flex justify-content-between`
                            : `col-9 d-flex justify-content-end`
                        }
                        style={{ gap: "22px" }}
                      >
