...
try{
    ...
    const images = [req.files.product_image1[0], req.files.product_image2[0], req.files.product_image3[0], req.files.product_image4[0]]
    console.log('req.files.product_image1[0]?', req.files.product_image1[0])
    const imagesLinks = []
    ...
    const insertproduct = new product({
      ...
      product_image1:imagesLinks[0]?.url,
      product_image2:imagesLinks[1]?.url,
      product_image3:imagesLinks[2]?.url,
      product_image4:imagesLinks[3]?.url,
